...
namespace
{
  const command_line::arg_descriptor<std::string> arg_config_file = {"config-file", "Specify configuration file", std::string(Q1v::CRYPTONOTE_NAME) + ".conf"};
...
int main(int argc, char* argv[])
{
  ...
  try {
    ...
    try {
      ...
      std::cout << "GENESIS_COINBASE_TX_HEX constant has an incorrect value. Please launch: " << Q1v::CRYPTONOTE_NAME << " --" << arg_print_genesis_tx.name;
      return 1;
    }
