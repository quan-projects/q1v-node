...
namespace Q1v {
  ...
  struct IP2pEndpoint {
    ...
    virtual bool invoke_notify_to_peer(int command, const BinaryArray& req_buff, const Q1v::CryptoNoteConnectionContext& context) = 0;
  ...
  struct p2p_endpoint_stub: public IP2pEndpoint {
    ...
    virtual bool invoke_notify_to_peer(int command, const BinaryArray& req_buff, const Q1v::CryptoNoteConnectionContext& context) override { return true; }
    virtual void for_each_connection(std::function<void(Q1v::CryptoNoteConnectionContext&, PeerIdType)> f) override {}
