...
namespace Q1v {
  ...
  public:
    OnceInTimeInterval(unsigned interval, Q1v::ITimeProvider& timeProvider)
  ...
  public:
    tx_memory_pool(
      const Q1v::Currency& currency,
      Q1v::ITransactionValidator& validator,
      Q1v::ITimeProvider& timeProvider,
      Logging::ILogger& log,
